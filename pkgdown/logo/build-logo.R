...
if (!file.exists(file.path(logo_dir, "bones-hex.svg"))) {
...
svg_markup <- paste(readLines(file.path(logo_dir, "bones-hex.svg")), collapse = "\n")
...
mark <- file.path(logo_dir, "bones-mark.svg")
...
# at tenmeh.github.io/bones/. A path that starts with "/" resolves to the
